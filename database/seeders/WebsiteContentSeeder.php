    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                ...
                'excerpt' => 'Lampung Timur, 15 September 2026 - Perkembangan kebutuhan garam konsumsi beryodium di Indonesia terus mengalami peningkatan seiring dengan kesadaran masyarakat akan produk berstandar SNI.',
                'content' => "Lampung Timur, 15 September 2026 – Perkembangan kebutuhan garam konsumsi beryodium di Indonesia terus mengalami peningkatan seiring dengan pemenuhan gizi keluarga dan standar mutu pangan nasional. Menjawab kebutuhan tersebut, CV. Banyu Mili yang berlokasi di Desa Banjar Rejo, Kabupaten Lampung Timur terus menjaga konsistensi mutu pemurnian dan kadar iodium sesuai Standar Nasional Indonesia (SNI).\n\nManajemen CV. Banyu Mili menyampaikan komitmennya untuk menghadirkan produk garam beryodium berkualitas prima yang higienis, bersih, dan aman dikonsumsi setiap hari oleh masyarakat luas.",
                'is_published' => true,
                'created_by' => $adminId,
            ],
            [
