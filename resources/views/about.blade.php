...
@section('content')
<section class="illutration_inside_page_top pg_about prelatife" style="background-image: url('{{ asset('asset/images/ptgaram/about-hero.jpg') }}');">
...
<div class="inside_page">
  <section class="default_sc back-white blocks_section_about_c1" id="about_c1">
    <div class="prelatife container">
      <div class="insides content-text prelatife">
	     ...
	     Sebagai perusahaan, kami berusaha melayani pelanggan kami dengan memberikan produk dan layanan terbaik. Untuk jaminan kualitas kami telah menerima <strong>ISO 9001: 2008, ISO 22000: 2005, Sertifikat Halal dari MUI dan SNI dari LS-Pro.</strong>
          ...
          <div class="col-md-6">
            <div class="rights_cont">
              <div class="tops padding-bottom-15">
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <div class="picture"><img src="{{ asset('asset/images/ptgaram/about-facility-1.jpg') }}" alt="" class="img-responsive"></div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <div class="picture"><img src="{{ asset('asset/images/ptgaram/about-facility-2.jpg') }}" alt="" class="img-responsive"></div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="picture"><img src="{{ asset('asset/images/ptgaram/slide-2.jpg') }}" alt="" class="img-responsive"></div>
                </div>
              </div>
...
<h5>Para pendiri pabrik garam CV. Banyu Mili  telah bersama-sama merancang sebuah budaya yang membimbing segala  aktifitas dan mendorong motifasi pekerjaan. Seluruh komponen perusahaan  bekerja dan memberikan hasil terbaiknya untuk memastikan budaya ini  terus berkelanjutan.</h5>            <div class="clear height-10"></div><div class="height-2"></div>
        ...
        <div class="snl_sinces_foot_about"></div>
        <div class="clear"></div>
      </div>
    </div>
  </section>
  ...
  <section class="default_sc blocks_bottoms_about_pillarns" id="about_c2">
    <div class="prelatife container">
      <div class="insides content-text text-center">
        <h2>Pilar penopang usaha garam<br />
CV. Banyu Mili</h2>
        <div class="clear height-50"></div>
