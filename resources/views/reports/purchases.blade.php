...
<div class="kpi-grid">
    <div class="kpi-card">
        <div class="kpi-label">Pembelian</div>
        <div class="kpi-value">Rp {{ number_format($totalSpent, 0, ',', '.') }}</div>
    </div>

    <div class="kpi-card">
        <div class="kpi-label">Berat Masuk</div>
        <div class="kpi-value">{{ $formattedTotalWeight }}</div>
    </div>

    <div class="kpi-card">
        <div class="kpi-label">Faktur</div>
...
<div class="md-card">
    ...
    <div class="table-responsive">
        <table class="md-table">
            ...
            <tfoot>
                <tr>
                    <td colspan="6" style="text-align: right; font-weight: 700; border-top: 2px solid var(--ux-border);">TOTAL:</td>
